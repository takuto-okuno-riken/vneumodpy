...
class ParseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--out', type=int, default=1, help='set output trials (perm & surrogate files) number <num> (default:1)')
        ...
        self.parser.add_argument('--njobs', type=int, default=8, help='number of jobs (multiprocessing) for glm calculation (default:8)')
