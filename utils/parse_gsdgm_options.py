...
class ParseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--lag', type=int, default=1, help='time lag <num> for VAR (default:1)')
        self.parser.add_argument('--noise', type=str, nargs=1, default='residuals', help='noise type for VAR surrogate model (default:"gaussian" or "residuals")')
        ...
        self.parser.add_argument('--surrnum', type=int, default=0, help='output surrogate sample number <num> (default:0)')
